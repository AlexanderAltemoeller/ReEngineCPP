...
{
	SDL_Rect destinationRectangle = { x, y, this->m_sourceRect.w * globals::SPRITE_SCALE, this->m_sourceRect.h * globals::SPRITE_SCALE };
	graphics.blitSurface(this->m_spriteSheet, &this->m_sourceRect, &destinationRectangle);
}
